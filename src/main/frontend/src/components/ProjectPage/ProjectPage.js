...
import { addProject } from '../../_actions/user_actions';
...
function ProjectPage() {
  ...
  return (
      <>
        <AddProject handleSubmit={handleSubmit} projectname={projectname} projectdetail={projectdetail} onChange={onChange} onSubmit={onSubmit}/>
