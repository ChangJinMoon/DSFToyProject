...
import { updateProject } from "../../_actions/user_actions";
        ...
        <div>
            {
                array?(
                    <>
                        <EditList handleSubmit={handleSubmit} projectname={projectname} projectdetail={projectdetail} onChange={onChange} onSubmit={onSubmit} />
                    </>
